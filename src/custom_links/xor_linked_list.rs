...
mod tests {
    ...
    fn test_drop() {
        ...
        struct ObjAdapter<'a>(
            LinkOps,
            DefaultPointerOps<Box<Obj<'a>>>,
            core::marker::PhantomData<Box<Obj<'a>>>,
        );
        unsafe impl<'a> Send for ObjAdapter<'a> {}
        unsafe impl<'a> Sync for ObjAdapter<'a> {}
        impl<'a> Clone for ObjAdapter<'a> {
            #[inline]
            fn clone(&self) -> Self {
                *self
            }
        }
        impl<'a> Copy for ObjAdapter<'a> {}
        impl<'a> Default for ObjAdapter<'a> {
            #[inline]
            fn default() -> Self {
                Self::new()
            }
        ...
        unsafe impl<'a> Adapter for ObjAdapter<'a> {
            ...
            unsafe fn get_value(
                ...
                container_of!(link.as_ptr(), Obj<'a>, link)
            }
            #[inline]
            unsafe fn get_link(
                &self,
